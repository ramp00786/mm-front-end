...
export const getStaticProps = async () =>{
    ...
    const dataRes = await fetch(process.env.API_URL+'/api/mm-predictions');
            ...
            <div className="container-fluid bg-dark p-5">
                <div className="row">
                    <div className="col-12 text-center">
                        <h1 className="display-4 text-white">Predictions</h1>
                        <Link href="/">Home</Link>
                        <i className="fas fa-chevron-right text-primary px-2"></i>
                        <Link href="/about-us">Predictions</Link>
                        ...
                        <div className=''>
                            ...
                            {data?.map( (mmmData, i) => (
                                <div className='document-link'  key={i}>
                                    <Link href={'/prediction/'+mmmData.slug}>
