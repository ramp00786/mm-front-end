...
export const getStaticProps = async () =>{
    //---Slider Data API
    const SscCommitteeData = await fetch(process.env.API_URL+'/api/ssc_committee');
    const SscData = await SscCommitteeData.json();
...
export default function SSC({SscData, dWS, dWL, upmeData, ssData}) {
    return (
        <>
            <Head>
