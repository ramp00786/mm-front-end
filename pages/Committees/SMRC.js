...
export const getStaticProps = async () =>{
    //---Slider Data API
    const SmrcCommitteeData = await fetch(process.env.API_URL+'/api/smrc_committee');
    const SmrcData = await SmrcCommitteeData.json();
...
export default function SMRC({SmrcData, dWS, dWL, upmeData, ssData}) {
    return (
        <>
            <Head>
